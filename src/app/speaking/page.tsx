      ...
      <section className="relative pt-40 pb-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            I don&apos;t just speak about growth. I share the raw, unpolished truth
            about scaling a company to $100M+ and the mindset required to
            survive the journey.
          </p>
          <Link
            href="/apply"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600">
              Tailored keynotes for founders, product teams, and corporate
              innovators.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Why 90% of founders become their own bottleneck, and the
                specific systems required to fire yourself from operations.
              </p>
              <div className="text-sm font-semibold text-orange-600">
                Best for: Founder Summits, Incubators
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                How to rebuild your entire GTM motion with AI agents. Forget
                &quot;chatbots&quot;—we&apos;re talking about autonomous revenue systems.
              </p>
              <div className="text-sm font-semibold text-orange-600">
                Best for: Tech Conferences, Growth Teams
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                The untold story of scaling without VC funding. The cash flow
                crunches, the hiring mistakes, and the eventual exit.
              </p>
              <div className="text-sm font-semibold text-orange-600">
                Best for: Startup Events, Corporate Innovation
              </div>
            </div>
          </div>
        </div>
