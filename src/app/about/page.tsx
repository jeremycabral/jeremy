...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-44 pb-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/apply"
                  className="flex-1 min-w-0 py-4 px-6 sm:px-8 bg-orange-600 text-white rounded-lg font-bold hover:bg-orange-700 transition-colors text-center whitespace-nowrap"
                >
                  Work With Me
                </Link>
                <Link
                  href="/newsletter"
                  className="flex-1 min-w-0 py-4 px-6 sm:px-8 border border-gray-700 text-white rounded-lg font-bold hover:bg-gray-800 transition-colors text-center whitespace-nowrap"
                >
                  Weekly Newsletter
                </Link>
              </div>
      ...
      <section className="py-10 md:py-12 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 text-center">
            <div>
              <div className="text-4xl font-bold text-gray-900 mb-1">$30M</div>
              <div className="text-sm text-gray-500 font-medium">Funds Raised</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-gray-900 mb-1">$650M</div>
              <div className="text-sm text-gray-500 font-medium">Valuation</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-gray-900 mb-1">$100M+</div>
      ...
      {/* Values */}
      <section className="py-12 md:py-24 bg-gray-900 text-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-6 md:mb-16">
            <h2 className="text-3xl font-bold mb-2 md:mb-4">Operating Principles</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            <div className="bg-white/5 p-5 md:p-8 rounded-2xl border border-white/10">
              <h3 className="text-xl font-bold text-orange-500 mb-2 md:mb-3">
