    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Half-day fortnightly advisory sprints combining $100M+ scale
              experience with AI-native execution.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Half-day strategic sessions every 2 weeks
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Results-focused advisory for scale-ups
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Implementation delivered at unprecedented speed
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle
                    className="text-orange-600 mr-3 flex-shrink-0 mt-1"
                    size={20}
                  />
                  <span className="text-gray-700">
                    SEO scaling to millions of visitors
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                ...
                <li className="flex items-start">
                  ...
                  />
                  <span className="text-gray-700">
                    Strategic PR and media strategies
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                  ...
                  />
                  <span className="text-gray-700">
                    Social virality frameworks for brands
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  />
                  <span className="text-gray-700">
                    Community and software integration
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
          ...
          <div className="bg-gradient-to-br from-orange-600 to-orange-700 rounded-3xl p-12 text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-orange-50 mb-8">
                Not ready for ongoing advisory? Book a one-off strategy session
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-lg text-gray-700">
                  Have $500K-$10M in annual revenue
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle
              ...
              <li className="flex items-start">
                ...
                />
                <span className="text-lg text-gray-700">
                  Are ready for significant investment in growth
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle
                ...
                />
                <span className="text-lg text-gray-700">
                  Are implementation-focused, not just strategy-focused
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle
                ...
                />
                <span className="text-lg text-gray-700">
                  Want systematic processes that scale to $10M+
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                $100M+ Bootstrap Experience
              </h3>
              <p className="text-gray-700 mb-4">
                Not theoretical advice—battle-tested playbooks from scaling a
                comparison platform to $100M+ revenue across 23 countries
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600 text-sm">
                    Proven at scale, not just startup phase
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                  ...
                  />
                  <span className="text-gray-600 text-sm">
                    Bootstrap efficiency with scale-up ambition
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              ...
              <p className="text-gray-700 mb-4">
                What agencies take months to deliver, we execute in weeks. Over
                3,000 AI interactions have built our proprietary execution
                engine.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              ...
              <p className="text-gray-700 mb-4">
                Unlike consultants who leave you with a deck, we implement.
                Unlike agencies who execute without strategy, we think
                strategically first.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  />
                  <span className="text-gray-600 text-sm">
                    Strategic advisory every 2 weeks
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              ...
              <p className="text-gray-700 mb-4">
                Access LinkedIn experts, ads specialists, and PR professionals
                without the overhead of hiring agencies or full-time team
                members.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
      ...
      <section className="py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <Download
                className="text-orange-600 mb-4 group-hover:translate-y-1 transition-transform"
                size={32}
              />
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                Scale-Up Playbook
              </h3>
              <p className="text-gray-600 text-sm">$1M to $10M frameworks</p>
            </a>
            <a
              href="#"
              className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-orange-600 transition-all group"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join scale-ups getting $100M+ proven playbooks with AI-native
            execution. Application-based qualification ensures the right fit.
          </p>
          <Link
            href="/apply/scaleup"
