...
import founderStoryImg from 'figma:asset/905ba77593df1229dd4fc3a49f71eab0882a3b23.png';
import heroImg from 'figma:asset/b47f319506824fb9919f642f7af7a8b5b661bc3b.png';
...
import marathonArticleImg from '../assets/marathon-article.png';
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             ...
             <div className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="h-48 bg-gray-200 relative">
               ...
               <div className="p-6">
                 ...
                 <a href="https://www.jeremycabral.com/p/how-i-used-ai-to-lose-20kg-in-4-months" target="_blank" rel="noopener noreferrer">
                 ...
                 <a href="https://www.jeremycabral.com/p/how-i-used-ai-to-lose-20kg-in-4-months" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-gray-900 hover:text-orange-600">Read Essay &rarr;</a>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
               ...
               <div className="p-6">
                 ...
                 <a href="https://www.jeremycabral.com/p/after-16-years-as-co-founder-of-finder" target="_blank" rel="noopener noreferrer">
                 ...
                 <a href="https://www.jeremycabral.com/p/after-16-years-as-co-founder-of-finder" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-gray-900 hover:text-orange-600">Read Essay &rarr;</a>
               </div>
             </div>
