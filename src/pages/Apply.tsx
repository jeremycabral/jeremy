...
export function Apply() {
  ...
  const serviceValue = service || 'startup';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/forms/apply', {
        ...
        body: JSON.stringify({ ...formData, source: 'apply-page' }),
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <Seo
        title="Apply for Growth Advisory - Jeremy Cabral"
        description="Apply to work with Jeremy Cabral's growth advisory. Limited spots each quarter."
        path="/apply"
      />
      <Navigation />
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                If you’re a business owner ready to scale with proven systems, strategies, and tactics, let’s connect! I work with a limited number of founders each quarter. Please tell me about your business so we can ensure I'm the right fit for your goals.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4 order-2 lg:order-1">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 sticky top-24">
                <div className="mb-8">
                  <h3 className="text-lg font-bold text-gray-900 mb-2">My Criteria</h3>
                  <p className="text-gray-600 text-sm">I'm looking for founders who are ready to execute, not just learn.</p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Selective Process</h4>
                      <p className="text-sm text-gray-500">I accept ~15% of applications to ensure high-touch attention.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">If I can't help you scale, I'll tell you upfront.</p>
                    </div>
                  </div>
                </div>

                <div className="mt-8 pt-8 border-t border-gray-100">
                  <h4 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4">Growth Playbooks Used By</h4>
                  <div className="grid grid-cols-2 gap-6 opacity-70">
                     <div className="flex items-center justify-center h-12 w-full">
                       <img src={canvaLogo} alt="Canva" className="max-h-6 max-w-full object-contain grayscale hover:grayscale-0 transition-all" />
                     </div>
                     <div className="flex items-center justify-center h-12 w-full">
                       <img src={airtaskerLogo} alt="Airtasker" className="max-h-12 max-w-full object-contain grayscale hover:grayscale-0 transition-all" />
                     </div>
                     <div className="flex items-center justify-center h-12 w-full">
                       <img src={finderLogo} alt="Finder" className="max-h-12 max-w-full object-contain grayscale hover:grayscale-0 transition-all" />
                     </div>
                     <div className="flex items-center justify-center h-12 w-full">
                       <img src={showpoLogo} alt="Showpo" className="max-h-12 max-w-full object-contain grayscale hover:grayscale-0 transition-all" />
                     </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="bg-gray-900 p-8 border-b border-gray-800">
                  <h2 className="text-2xl font-bold text-white flex items-center">
                    Application Form
                    <span className="ml-4 text-xs bg-orange-600 text-white px-2 py-1 rounded uppercase tracking-wide">Confidential</span>
                  </h2>
                </div>
                ...
                <div className="p-8 md:p-10 space-y-8">
                  {isSubmitted && (
                    <div className="rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800">
                      Thanks for applying. We have received your submission.
                    </div>
                  )}
                  {submitError && (
                  ...
                  <div>
                    <label htmlFor="challenge" className="block text-sm font-medium text-gray-700 mb-2">
                      What is the biggest bottleneck preventing you from growing right now?
                    </label>
                    <textarea
                      name="challenge"
                      required
                  ...
                  <div className="pt-4">
                    ...
                    <div className="text-center mt-4 space-y-2">
                      <p className="text-sm text-gray-500">
                        By submitting this form, you agree to my <Link to="/terms-of-use" className="underline text-gray-500 hover:text-gray-700">Terms of Use</Link>.
                      </p>
                    </div>
                  </div>
                </div>
