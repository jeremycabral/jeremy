...
export function About() {
  return (
    <div className="min-h-screen bg-white">
      <Seo
        title="About & Bio - Jeremy Cabral"
        description="Founder, builder, and growth obsessive. 25+ years scaling a bootstrapped startup to $100M+ revenue."
        path="/about"
      />
      <Navigation />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-400 mb-8 leading-relaxed">
                I'm Jeremy Cabral. I spent the last 25+ years building a bootstrap startup from a bedroom idea to a $100M+ revenue global platform. Now, I help other founders do it faster.
              </p>
              <div className="flex gap-4">
                <Link to="/apply" className="px-8 py-4 bg-orange-600 text-white rounded-lg font-bold hover:bg-orange-700 transition-colors">
                  Work With Me
                </Link>
                <Link to="/newsletter" className="px-8 py-4 border border-gray-700 text-white rounded-lg font-bold hover:bg-gray-800 transition-colors">
                  Weekly Newsletter
                </Link>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white text-black p-6 rounded-xl shadow-xl max-w-xs">
                <p className="font-serif italic text-lg">
                  "Business is the ultimate sport. The scoreboard is revenue, but the trophy is freedom."
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-500 font-medium">Bootstrapped Revenue</div>
            </div>
            <div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto prose prose-lg prose-orange">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mt-12">Why I'm Doing This Now</h3>
          <p>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl mt-12 not-prose border border-gray-100">
            ...
            <p className="text-gray-600 mb-0">
              When I'm not scaling businesses, I love hanging out with my wife and twin girls and travelling the world. I also recently lost 20kg and ran a marathon—applying the same discipline to health as I do to business.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-900 text-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">How I work and what I expect from founders I work with.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <h3 className="text-xl font-bold text-orange-500 mb-3">Speed Over Perfection</h3>
              <p className="text-gray-400">
                The market doesn't reward perfect plans. It rewards fast execution. We ship, we learn, we iterate.
              </p>
            </div>
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <h3 className="text-xl font-bold text-orange-500 mb-3">Systems Over Hustle</h3>
              <p className="text-gray-400">
                Hustle gets you to $1M. Systems get you to $100M. If you can't automate it or delegate it, you're the bottleneck.
              </p>
            </div>
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <h3 className="text-xl font-bold text-orange-500 mb-3">Brutal Honesty</h3>
              <p className="text-gray-400">
                I will tell you what you need to hear, not what you want to hear. Growth requires confronting reality.
              </p>
            </div>
          </div>
        </div>
